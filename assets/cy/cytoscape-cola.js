    ...
    return (function () {
    ...
    })()(
        {
                    ...
                    var f = a('./layout'),
                        g = (function (a) {
                            ...
                            return (
                                e(b, a),
                                (b.prototype.trigger = function (a) {
                                    var b = { type: f.EventType[a.type], alpha: a.alpha, stress: a.stress };
                                    this.event[b.type](b);
                                }),
                                (b.prototype.kick = function () {
                                    var b = this;
                                ...
                                (b.prototype.on = function (a, b) {
                                    return (
                                        'string' == typeof a ? this.event.on(a, b) : this.event.on(f.EventType[a], b),
                                        this
                                    );
                                }),
                                b
                    ...
                    var e = a('./layout'),
                        f = (function (a) {
                            ...
                            return (
                                d(b, a),
                                (b.prototype.trigger = function (a) {
                                    var b = { type: e.EventType[a.type], alpha: a.alpha, stress: a.stress };
                                ...
                                (b.prototype.on = function (a, b) {
                                    return (
                                        'string' == typeof a ? this.event.on(a, b) : this.event.on(e.EventType[a], b),
                                        this
                                    );
                                }),
                                b
                        ...
                        return (
                                    ...
                                    for (
                                        ...
                                        for (d = 0; d < this.k; ++d) {
                                            var A = this.x[d][i],
                                                ...
                                                D = B - C,
                                                E = Math.abs(C),
                                                m = E <= 0.5 ? A - D * w : A > 0 ? A - (D + 1) * w : A - (D - 1) * w;
                                            -v < m &&
                                                m <= v &&
                                                (this.scaleSnapByMaxH
                                                    ? ((this.g[d][i] += h * y * m), (this.H[d][i][i] += h * y))
                                                    : ((this.g[d][i] += y * m), (this.H[d][i][i] += y)));
                                        }
                                    this.locks.isEmpty() ||
                                        this.locks.apply(function (c, e) {
                                            for (d = 0; d < b.k; ++d)
                                                (b.H[d][c][c] += h), (b.g[d][c] -= h * (e[d] - a[d][c]));
                                        });
                                }
                            }),
                            ...
                            (a.prototype.computeNextPosition = function (a, b) {
                                ...
                                if ((this.stepAndProject(a, b, this.g, d), this.project)) {
                                    ...
                                    (e = Math.max(0.2, Math.min(e, 1))), this.stepAndProject(a, b, this.e, e);
                                }
                            }),
                    ...
                    var f = (function () {
                        ...
                        return (
                            (a.prototype.getNext = function () {
                                return (
                                    (this.seed = (this.seed * this.a + this.c) % this.m), (this.seed >> 16) / this.range
                                );
                            }),
                        ...
                        for (var c = a.length - 1, e = b.length - 1, f = new B(), g = 0; g < c; ++g)
                            for (var h = 0; h < e; ++h) {
                                ...
                                o >= 0 && p >= 0 && q < 0 && r >= 0 && s >= 0 && t < 0
                                    ...
                                    : o <= 0 && p > 0 && q <= 0 && r >= 0 && s < 0 && t >= 0
                                    ? (f.rl = new A(g, h))
                                    : o >= 0 && p < 0 && q >= 0 && r <= 0 && s > 0 && t <= 0 && (f.lr = new A(g, h));
                            }
                        return f;
                    }
                    function s(a, b) {
                    ...
                    var i = (function () {
                        function a(b, c) {
                            ...
                            var d = a.findMatch(b, c),
                                ...
                                f = a.findMatch(b, e);
                            d.length >= f.length
                                ? ((this.length = d.length), (this.si = d.si), (this.ti = d.ti), (this.reversed = !1))
                                ...
                                p.forEach(function (a, b) {
                                    ...
                                    for (var f = 1; f < a.verts.length; f++) {
                                        ...
                                        (g.node && g.node === i.node && g.node.leaf) ||
                                            e.edges.push({ source: g.id, target: i.id, length: Math.abs(d(g, i)) });
                                    }
                                });
                        }
                        return (
                            ...
                            (a.prototype.findAncestorPathBetween = function (a, b) {
                                ...
                                return { commonAncestor: c[e - 1], lineages: c.slice(e).concat(d.slice(e)) };
                            }),
                                    ...
                                    for (
                                        ...
                                        for (var l = 0; l < h; l++)
                                            if (k !== l) {
                                                ...
                                                'x' == a
                                                    ? f(o, p) &&
                                                      (m[0][b] < m[1][b] ? ((q = l), (r = k)) : ((q = k), (r = l)))
                                                    : f(o, p) &&
                                                      (m[0][b] < m[1][b] ? ((q = k), (r = l)) : ((q = l), (r = k))),
                                ...
                                for (var g = a.getSegmentSets(b, c, d), h = 0; h < g.length; h++) {
                                    for (var i = g[h], j = [], k = 0; k < i.segments.length; k++) {
                                        ...
                                        j.push({ type: 0, s: l, pos: Math.min(l[0][d], l[1][d]) }),
                                            j.push({ type: 1, s: l, pos: Math.max(l[0][d], l[1][d]) });
                                    }
                                    j.sort(function (a, b) {
                                ...
                                for (var c = [], d = 0; d < b.length - 1; d++)
                                    for (var e = d + 1; e < b.length; e++) {
                                        var f,
                                            ...
                                            l = new i(j, k);
                                        0 !== l.length &&
                                            (l.reversed && (k.reverse(), (k.reversed = !0), (l = new i(j, k))),
                                            (l.si <= 0 || l.ti <= 0) &&
                                            (l.si + l.length >= j.length || l.ti + l.length >= k.length)
                                                ? c.push({ l: d, r: e })
                                                : (l.si + l.length >= j.length || l.ti + l.length >= k.length
                                                      ? ((f = j[l.si + 1]), (h = j[l.si - 1]), (g = k[l.ti - 1]))
                                                      : ((f = j[l.si + l.length - 2]),
                                                        (g = j[l.si + l.length]),
                                                        (h = k[l.ti + l.length])),
                                                  a.isLeft(f, g, h) ? c.push({ l: e, r: d }) : c.push({ l: d, r: e })));
                                    }
                                return a.getOrder(c);
                            }),
                            ...
                            (a.prototype.route = function (a, b) {
                                ...
                                return (
                                    ...
                                    q.filter(function (a, b) {
                                        return !(
                                            (b < q.length - 1 && q[b + 1].node === d && a.node === d) ||
                            ...
                            (a.getRoutePath = function (b, c, d, e) {
                                var f = { routepath: 'M ' + b[0][0].x + ' ' + b[0][0].y + ' ', arrowpath: '' };
                                if (b.length > 1)
                                    for (var g = 0; g < b.length; g++) {
                                        ...
                                        if (g < b.length - 1) {
                                            ...
                                            var w,
                                                ...
                                                y = [i, j];
                                            Math.abs(k) > 0
                                                ? ((i -= (k / Math.abs(k)) * e), (w = [i, j + d]), (x = [i, j - d]))
                                                : ((j -= (l / Math.abs(l)) * e), (w = [i + d, j]), (x = [i - d, j])),
                                                (f.routepath += 'L ' + i + ' ' + j + ' '),
                                                e > 0 &&
                                                    (f.arrowpath =
                                                        'M ' +
            ...
            10: [
                function (a, b, c) {
                    ...
                    function d(a, b, c, d, e, g) {
                        ...
                        function i(a, b) {
                            for (var c = void 0, d = 0; d < t.length; d++)
                                if (
                                    t[d].space_left >= a.height &&
                                    t[d].x + t[d].width + a.width + f.PADDING - b <= f.FLOAT_EPSILON
                                ) {
                                    c = t[d];
                                    break;
                                }
                                ...
                                (function (a) {
                                    a.forEach(function (a) {
                                        ...
                                        var c = { x: b.x - a.width / 2, y: b.y - a.height / 2 },
                                            d = { x: a.x - c.x + n / 2 - p / 2, y: a.y - c.y + o / 2 - q / 2 };
                                        a.array.forEach(function (a) {
                                            (a.x += d.x), (a.y += d.y);
                                        });
                                    });
                    ...
                    function e(a, b) {
                        function c(a, b) {
                            if (void 0 === d[a.index]) {
                                b && (g++, f.push({ array: [] })), (d[a.index] = g), f[g - 1].array.push(a);
                                var h = e[a.index];
                        ...
                        return (
                            (a.prototype.on = function (a, b) {
                                return (
                                    ...
                                    'string' == typeof a ? (this.event[e[a]] = b) : (this.event[a] = b),
                                    this
                                );
                            }),
                            ...
                            (a.prototype.tick = function () {
                                ...
                                return (
                                    0 === f ? (this._alpha = 0) : void 0 !== this._lastStress && (this._alpha = f),
                                    (this._lastStress = f),
                                    this.updateNodePositions(),
                                    this.trigger({ type: e.tick, alpha: this._alpha, stress: this._lastStress }),
                                    !1
                                );
                            }),
                            (a.prototype.updateNodePositions = function () {
                                for (
                                    var a, b = this._descent.x[0], c = this._descent.x[1], d = this._nodes.length;
                                    d--;
                                    ...
                                    ? ((a = +a),
                                      this._alpha
                                          ...
                                          : a > 0 &&
                                            (this._running ||
                                                ((this._running = !0),
                                                this.trigger({ type: e.start, alpha: (this._alpha = a) }),
                                                this.kick())),
                                      this)
                                    : this._alpha;
                            }),
                            ...
                            (a.prototype.start = function (b, c, d, e, f, k) {
                                ...
                                this._distanceMatrix
                                    ...
                                    : ((v = new j.Calculator(
                                      ...
                                      (t = h.Descent.createSquareMatrix(o, function () {
                                          return 2;
                                      })),
                                      this._links.forEach(function (a) {
                                ...
                                if (this._rootGroup && void 0 !== this._rootGroup.groups) {
                                    ...
                                    this._groups.forEach(function (a) {
                                        x(m, m + 1, l._groupCompactness, 0.1),
                                            (r[m] = 0),
                                            (s[m++] = 0),
                                            (r[m] = 0),
                                            (s[m++] = 0);
                                ...
                                if (
                                    ...
                                    this._descent.run(c),
                                    this.separateOverlappingComponents(p, q, k),
                                    this.avoidOverlaps(u),
                                    u &&
                                        (this._nodes.forEach(function (a, b) {
                                            (a.x = r[b]), (a.y = s[b]);
                                        }),
            ...
            12: [
                ...
                { './descent': 7, './linklengths': 13, './rectangle': 17, './shortestpaths': 18 },
            ],
            13: [
                function (a, b, c) {
                    'use strict';
                    ...
                    function j(a, b, c, d) {
                        ...
                        return (
                            b.forEach(function (a) {
                                ...
                                f[b] !== f[e] && g.push({ axis: c, left: b, right: e, gap: d.getMinSeparation(a) });
                            }),
                            g
                        );
                    }
                    function k(a, b, c) {
                        ...
                        for (var e = [], f = 0, g = [], h = [], i = 0; i < a; i++) e.push({ id: i, out: [] });
                            ...
                            (a.prototype.rootMerges = function (a) {
                                ...
                                for (
                                    ...
                                    for (var h = f + 1; h < c; ++h) {
                                        var i = b[f],
                                            j = b[h];
                                        (d[e] = { id: e, nEdges: this.nEdges(i, j), a: i, b: j }), e++;
                                    }
                                return d;
                            }),
                        ...
                        return (
                            ...
                            (a.prototype.push = function () {
                                ...
                                for (var c, e, f = 0; (e = a[f]); ++f)
                                    (c = new d(e)), (this.root = this.empty() ? c : this.root.merge(c, this.lessThan));
                                return c;
                            }),
                            (a.prototype.empty = function () {
                        ...
                        h = (function (a) {
                            ...
                            return (
                                ...
                                (b.prototype.insert = function (a) {
                                    var c = !1;
                                    if (null === this._root) (this._root = new g(a)), (c = !0), this.size++;
                                    else {
                                        var d = new g(void 0),
                                            e = !1,
                                            f = !1,
                                        ...
                                        for (i.right = this._root; ; ) {
                                            if (
                                                (null === k
                                                    ? ((k = new g(a)), j.set_child(e, k), (c = !0), this.size++)
                                                    : b.is_red(k.left) &&
                                                      b.is_red(k.right) &&
                                                      ((k.red = !0), (k.left.red = !1), (k.right.red = !1)),
                                ...
                                (b.prototype.remove = function (a) {
                                    ...
                                    for (var e = null, f = null, h = null, i = !0; null !== d.get_child(i); ) {
                                        ...
                                        if (
                                            ((i = k > 0), 0 === k && (h = d), !b.is_red(d) && !b.is_red(d.get_child(i)))
                                        )
            ...
            17: [
                function (a, b, c) {
                    ...
                    function e(a, b, c) {
                        var d = a.rayIntersection(b.cx(), b.cy()) || { x: a.cx(), y: a.cy() },
                        ...
                        return (
                            ...
                            (a.lineIntersection = function (a, b, c, d, e, f, g, h) {
                                ...
                                var n = a - e,
                                    ...
                                    r = i * o - k * n,
                                    s = r / m;
                                return q >= 0 && q <= 1 && s >= 0 && s <= 1 ? { x: a + q * i, y: b + q * k } : null;
                            }),
                        ...
                        return (
                            ...
                            (a.prototype.setupVariablesAndBounds = function (a, b, c, d) {
                                this.nodes.forEach(function (e, f) {
                                    e.fixed
                                        ? ((e.variable.weight = e.fixedWeight ? e.fixedWeight : 1e3), (c[f] = d(e)))
                                        : (e.variable.weight = 1);
                                    var g = (e.width || 0) / 2,
                                        h = (e.height || 0) / 2,
                                        i = a[f],
                ...
                function (a, b, c) {
                    ...
                    function d(a, b, c) {
                        ...
                        var m = d[0],
                            ...
                            r = null;
                        return (
                            b && ((q = new g(b, 1e3 * m.weight)), d.push(q), e.push(new f(q, m, o))),
                            c && ((r = new g(c, 1e3 * n.weight)), d.push(r), e.push(new f(n, r, p))),
                            new j(d, e).solve(),
                            {
                    ...
                    var j = (function () {
                        ...
                        return (
                            ...
                            (a.prototype.mostViolated = function () {
                                for (
                                    var b = Number.MAX_VALUE, c = null, d = this.inactive, e = d.length, f = e, g = 0;
                                    g < e;
                                    ++g
                                ) {
                                    var h = d[g];
